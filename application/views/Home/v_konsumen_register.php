...
<body>
                ...
                <div class="contact">
                    <div class="row">
                     <div id="responseDiv" class="alert text-center" style=" display:none;">
                                ...
                                <form id="Form_register_konsumen">
                                    ...
                                    <div class="row">
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="field-text textbox"  name="nama" id="nama" placeholder="Masukan Nama Lengkap" style="margin-top: -2px !important;">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="field-text textbox"  name="alamat" id="alamat" placeholder="Masukan Alamat" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="field-text textbox"  name="no_tlp" id="no_tlp" placeholder="Masukan No Tlp" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="field-text textbox"  name="kota" id="kota" placeholder="Masukan Nama Kota" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
                                    </div>
                            ...
                            <div class="contact-form">
                                    ...
                                    <div class="row">
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="field-text textbox"  name="email" id="email" placeholder="Masukan Email" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="field-text textbox"  name="username" id="username" placeholder="Masukan Username" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="password" class="field-text textbox"  name="password" id="password" placeholder="Masukan Password" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="password" class="field-text textbox"  name="conf_password" id="conf_password" placeholder="Masukan Konfiamasi Password" style="margin-top: -2px !important;">
                                            <i class="form-control-feedback"></i>
                                            <span class="text-warning" ></span>
                                          </div>
    ...
    $(document).ready(function(){
      //semua element dengan class text-warning akan di sembunyikan saat load
        ...
        $('#Form_register_konsumen').submit(function(e){
            e.preventDefault();
                var valid=true;     
                ...
                var user = $('#Form_register_konsumen').serialize();
                  ...
                  $.ajax({
                    ...
                    success:function(response){
                      ...
                      if(response.error){
                        ...
                        $('#Form_register_konsumen')[0].reset();
                      }
                    }
                  });
                };
