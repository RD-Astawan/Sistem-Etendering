...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url().'assets/Home/theme/images/favicon.png'?>"/>
                            ...
                            ?>
                                ...
                                <article class="post">
                                    ...
                                    <div class="entry-media">
                                        <a href="<?php echo site_url('post/'.$row->post_slug);?>" class="post-thumbnail hover-zoom"><img src="<?php echo base_url().'assets/Gambar/post/'.$row->post_gambar;?>" alt=""></a>
                                    ...
                                    <div class="entry-header">
                                        <h2 class="entry-title"><a href="<?php echo site_url('post/'.$row->post_slug);?>"><?php echo $row->post_judul;?></a></h2>
                                    </div>

                                    <div class="entry-content">
                                        <?php echo limit_words($row->post_isi,70).'<b>...</b>';?>
                                    </div>
                                        ...
                                        <p class="entry-meta">
                                            ...
                                            <span class="entry-author">
                                                ...
                                                <a href="#" class="entry-author-link">
                                                    <span class="entry-author-name"><?php echo $row->post_author;?></span>
                                                </a>
                                            </span>

                                            <span class="entry-categories">
                                                <a href="#">seharusnya kategori</a>
                                            </span>

                                            <span class="entry-comments-link">
                                                <a href="#">seharusnya Views</a>
                                            </span>
