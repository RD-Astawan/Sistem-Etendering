...
<head>
   ...
   <link rel="shortcut icon" href="<?php echo base_url().'assets/Home/theme/theme/images/favicon.png'?>"/>
               ...
               <ul>
                  ...
                  ?>
                    <li data-transition="fade">
                        <img src="<?php echo base_url().'assets/Gambar/slider/'.$i->gambar;?>" data-bgposition="left center" data-duration="14000" data-bgpositionend="right center" alt="">
                     ...
                     <div class="col-lg-9">
                        <div class="availability-form">
                              <div class="vailability-submit">
                                 <a href="<?php echo site_url('');?>" class="awe-btn awe-btn-13">INFO</a>
                              </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="room-detail_compare">
                  <div class="row">
                     <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                        <div class="ot-heading row-20 mb30 text-center">
                           <h2 class="shortcode-heading">TENDER TERBARU</h2>
                        </div>
                     </div>
                  </div>
                  <div class="room-compare_content">
                     <div class="row">
                        <!-- ITEM -->
                        <?php 
                           foreach($tender->result() as $j):
                        ?>
                              <div class="col-sm-3 col-md-3 col-lg-3">
                                 <div class="room-compare_item">
                                    <div class="img">
                                       <a href="<?php echo site_url('tender');?>"><img class="img img-responsive" src="<?php echo base_url().'assets/Gambar/tender/'.$j->gambar;?>" alt="<?php // echo $j->type;?>"></a>
                                    </div>  
                                    <div class="text">
                                       <h2><a herf="<?php // echo site_url('rooms');?>"><?php  echo $j->tittle;?></a></h2>
                                       <ul>
                     ...
                     <div class="text-center">
                        <a href="<?php echo site_url('Home/view_more_tender');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">View More</a>
                     </div>
                  </div>
               ...
               <div class="content">
                  <div class="row">
                     <div class="col col-xs-12 col-lg-6 col-lg-offset-3">
                        ...
                        <div class="ot-heading row-20 mb30 text-center">
                            <h2 class="shortcode-heading">TENDER DEAL</h2>
                        </div>
                     </div>
                     <div class="row">
                        <?php 
                           foreach($pengerjaan->result() as $j):
                        ?>
                           <div class="col-xs-12 col-sm-6">
                              <div class="item item-deal">
                                 <div class="img">
                                    <img class="img-full" src="<?php echo base_url().'assets/Gambar/tender/large/'.$j->pengerjaan_gambar;?>" alt="">
                                 </div>
                                 <div class="info">
                                    <a class="title bold f26 font-monserat upper" href="!#">10 Ptg Brahma</a>
                                    <p class="sub font-monserat f12 f-600 upper mt10 mb20">deal</p>
                                    <a class="awe-btn awe-btn-12 btn-medium font-hind f12 bold" href="<?php echo site_url('contact');?>">Lihat</a>
                                 </div>
                              </div>
                           </div>
                        <?php  endforeach; ?>
                     ...
                     <div class="col-md-8 col-md-push-4">
                        <div class="blog-content events-content">
                           <div class="content">
                              ...
                              <div class="row">
                                 <?php foreach($post->result() as $post):?>
                                    <div class="col-xs-12 col-sm-4">
                                       <div class="item">
                                          <div class="img">
                                             <a href="<?php echo site_url('post/'.$post->post_slug);?>"><img class="img-responsive img-full" src="<?php echo base_url().'assets/Gambar/post/'.$post->post_gambar;?>" alt="<?php echo $post->post_judul;?>"></a>
                                          </div>
                                          <div class="info"><br>
                                             <a class="title font-monserat f14 mb20 block bold upper" href="<?php echo site_url('post/'.$post->post_slug);?>"><?php echo $post->post_judul;?></a>
                                          </div>
                                       </div>
                                    </div>
                                 <?php  endforeach;?>
                              ...
                              <div class="text-center">
                                 <a href="<?php echo site_url('post');?>" class="awe-btn awe-btn-default font-hind f12 bold btn-medium mt15">View more</a>
                              </div>
                           </div>
                        </div>
                     </div> 
                     <div class="col-md-4 col-md-pull-8">
                        <div class="sidebar">
                           ...
                           <div class="widget widget_upcoming_events">
                              <h4 class="widget-title">Tender Terpopuler</h4>
                              <ul>
                                 <?php if(is_array($top_lamaran)): ?>
                                 <?php
                                    foreach($top_lamaran as $data){
                                       $tanggal_tutup = $data->tanggal_tutup;
                                       $nama = $data->tittle; 
                                       $merk = $data->id_tender; 
                                       $stok = (float) $data->hasil;?><br><?php
                                 ?>
                                       <li>
                                          <span class="event-date">
                                             <strong><?php echo $stok; ?></strong>
                                             <small><?php echo 'Lamaran'?></small>
                                          </span>
                                          <div class="text">
                                             <a href="#"><?php echo $nama;?></a>
                                             <span class="date"><?php echo $tanggal_tutup;?></span>
                                          </div>
                                       </li>
                                    <?php
                                    }
