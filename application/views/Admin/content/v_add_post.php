                           ...
                           <div class="col-md-8">
                              <div class="block">
                                 <div class="block-header block-header-default">
                                    <h5 class="block-title">Tambah Post Baru</h5>
                                 </div>
                                 <div class="block-content">
                                    <div class="form-group">
                                       <input type="text" name="post_judul" id="post_judul" class="form-control textbox" placeholder="Post Title">
                                       <span class="text-warning" ></span>
                                    </div>
                                    <div class="form-group">
                                       <input type="text" name="post_slug" class="form-control" placeholder="URL Permalink, contoh: ini-adalah-url" style="background-color: #F8F8F8;outline-color: none;border:0;color:blue;" required>
                                    </div>
                                    <div class="form-group">
                                       <textarea name="post_isi" id="ckeditor"></textarea>
                                    </div>
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="block">
                                 ...
                                 <div class="block-content">
                                    ...
                                    <div class="form-group">
                                       <input type="file" name="post_file" id="post_file" class="form-control textbox">
                                       <span class="text-warning" ></span>
                                    </div>
                                    <div class="form-group">
                                 ...
                                 <div class="block-content block-content-full block-content-md bg-body-light" style="margin-top: 93px;">
                                           
                                    <button type="submit" class="btn btn-primary btn-square btn-block">TERBITKAN</button>
                                 </div>
                              </div> 
                           </div>
                        </div>
                     ...
                     $.ajax({
                        ...
                        async:false,
                           success: function(data){
                             ...
                             toastr.success('Data post berhasil disimpan.', 'Berhasil!');
                           }
                     });    
               }         
            });
