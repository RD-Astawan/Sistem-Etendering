...
<div class="right_col" role="main">
   <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
         <div class="x_panel">
            <div class="x_title">
               <h5><b>Tambah Data Slider <?php echo $row->id->slider; ?></b></h5>
                     ...
                     <div class="card mb-3" style="max-width: 100%;">
                        <div class="row no-gutters">
                           <div class="col-md-6">
                              <div class="card-body">
                                 <div class="x_content">
                                    <form id="from_Edit_Sliders" enctype="multipart/form-data">
                                       <input type="hidden" name="id_slider" value="<?php echo $dataSlider->id_slider ?>" class="form-control caption textbox" placeholder="Masukan Keterangan Slider 1">
                                                      
                                       <div class="form-group">
                                          <label>Keterangan 1</label>
                                          <input type="text" name="caption_1" value="<?php echo $dataSlider->caption_1 ?>" class="form-control caption textbox" placeholder="Masukan Keterangan Slider 1">
                                          <span class="text-warning" ></span>
                                       </div>

                                       <div class="form-group">
                                          <label>Keterangan 2</label>
                                          <input type="text" name="caption_2" value="<?php echo $dataSlider->caption_2 ?>" class="form-control caption textbox" placeholder="Masukan Keterangan Slider 2">
                                          <span class="text-warning" ></span>
                                       </div>

                                       <div class="form-group">
                                          <label>Keterangan 3</label>
                                          <input type="text" name="caption_3" value="<?php echo $dataSlider->caption_3 ?>" class="form-control caption textbox" placeholder="Masukan Keterangan Slider 3">
                                          <span class="text-warning" ></span>
                                       </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              ...
                              <div class="form-group" style="margin-left: 15px;">
                                 <button class="btn btn-warning btn-sm" type="button" style="width: 70px;" onclick="location.href='<?php echo base_url();?>page/slider'">Kembali</button>
                                 <button class="btn btn-primary btn-sm" type="reset" style="width: 70px;">Reset</button>
                                 <button type="submit" id="btn_update" class="btn btn-success btn-sm" style="width: 70px;">Submit</button>
                              </div>
                           </div>
                        </div>
                                    </form>
...
<script type="text/javascript">
   $(document).ready(function(){
      ...
      $('#from_Edit_Sliders').submit(function(e){
                     e.preventDefault();
            var valid=true;     
            ...
            if(valid){             
               ...
               var formData = new FormData($(this)[0]);
                 $.ajax({
                   type: 'POST',
                   url: url + 'admin/Slider/update_data_sliders',
                   data: formData,
                    processData:false,
                    contentType:false,
                    cache:false,
                   ...
                   success: function(data){
                    ...
                    toastr.success('Data sliders berhasil dirubah.', 'Berhasil!');
                   }
