          ...
          <div class="row">
            <div class="col-md-12">
              <form id="change_password">
                  ...
                  <div class="col-sm-8">
                    <input type="hidden" class="form-control" name="password_database" value="<?= $password->password ?>">
                  </div>
                </div>

                <div class="form-group row">
                  <div class="col-sm-8">
                    <input type="hidden" class="form-control" name="id_produsen" value="<?= $password->id_produsen ?>">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control textbox" name="password_lama" id="password_lama">
       ...
       $('#change_password').submit(function(e){
           e.preventDefault();
               ...
               var formData = new FormData($("#change_password")[0]);
                 $.ajax({
                   type: 'POST',
                   url: url + 'pro_page/save_new_pass',
                   dataType: 'json',
                   data: formData,
                    processData:false,
                    contentType:false,
                   ...
                   success: function(response){
                    if(response.warning){
                      ...
                      toastr.options.onHidden = function() { window.location.href = 'edit_password'; }
