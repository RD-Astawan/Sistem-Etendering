                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-right">
                                 <a href="<?php echo base_url() ?>pro_page/edit_profile/<?php echo $row['id_produsen']; ?>"><button type="button" class="btn btn-sm btn-info">EDIT PROFILE</button></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card-box tilebox-one"><i class="icon-layers float-right text-muted"></i>
                            <h6 class="text-muted text-uppercase mt-0" style="text-align: center;">Jumlah Lamaran Terdaptar</h6>
                            <h2 class="" data-plugin="counterup" style="text-align: center;"><?php echo $jum_lamaran->num_rows(); ?></h2>
                            <center><span class="badge badge-custom">Lamaran Tedaftar</span></center></div>
                    </div>
                    <!-- end col -->
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <div class="card-box tilebox-one"><i class="icon-rocket float-right text-muted"></i>
                            ...
                            <h2 class="" data-plugin="counterup" style="text-align: center;"><?php echo $jum_tender_selesai->proyek_selesai; ?></h2><center><span class="badge badge-custom">Tender Selesai</span></center></div>
                    </div>
                    <!-- end col -->
                </div>
                <!-- end row -->
                <div class="card-box">
                    <h4 class="header-title mb-3">Projek yang Berjalan</h4>
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <tr>
                                    <th style="5%;">#</th>
                                    <th style="width: 70%;">Judul Tender</th>
                                    <th>Deadline</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                    $nomer = 1;
                                    foreach ($jum_tender_dikerjakan->result() as $data) {
                                    
                                ?>
                                <tr>
                                    <td><?php echo $nomer; ?></td>
                                    <td><?php echo $data->pengerjaan_judul; ?></td>
                                    <td align="center"><?php echo $data->pengerjaan_deadline; ?></td>
                                    </td>
                                </tr>
                                    <?php $nomer++; } ?>
                            </tbody>
