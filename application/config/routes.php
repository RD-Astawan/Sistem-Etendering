...
*/
$route['page'] = 'AdminMainPage';
$route['page/(:any)'] = 'AdminMainPage/$1';
$route['page/(:any)/(:any)']    = 'AdminMainPage/$1/$2';
$route['post/(:any)']='post/detail/$1';

$route['kon_page'] = 'KonsumenMainPage';
$route['kon_page/(:any)'] = 'KonsumenMainPage/$1';
